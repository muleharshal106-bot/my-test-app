...
.method public b()Ljava/net/HttpURLConnection;
    ...
    .line 5
    new-instance v1, Lc/b/c/x/g;

    invoke-virtual {v0}, Ljava/io/IOException;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lc/b/c/x/g;-><init>(Ljava/lang/String;)V
...
.method public fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Date;)Lc/b/c/x/o/k$a;
    .locals 4
    ...
    .line 8
    :cond_0
    invoke-static {v2, p5}, Lc/b/a/b/b/p/e;->a([BZ)Ljava/lang/String;
    ...
    .line 27
    new-instance p1, Lc/b/c/x/o/k$a;

    invoke-direct {p1, p7, v0, v1, v1}, Lc/b/c/x/o/k$a;-><init>(Ljava/util/Date;ILc/b/c/x/o/f;Ljava/lang/String;)V
    ...
    :cond_2
    :try_start_4
    invoke-static {}, Lc/b/c/x/o/f;->b()Lc/b/c/x/o/f$b;

    move-result-object p1

    .line 29
    iput-object p7, p1, Lc/b/c/x/o/f$b;->b:Ljava/util/Date;
    :try_end_4
    ...
    invoke-direct {p6, p4}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V

    iput-object p6, p1, Lc/b/c/x/o/f$b;->a:Lorg/json/JSONObject;
    :try_end_6
    ...
    invoke-direct {p6, p4}, Lorg/json/JSONArray;-><init>(Ljava/lang/String;)V

    iput-object p6, p1, Lc/b/c/x/o/f$b;->c:Lorg/json/JSONArray;
    :try_end_8
    ...
    iput-object p3, p1, Lc/b/c/x/o/f$b;->d:Lorg/json/JSONObject;
    :try_end_a
    ...
    :cond_5
    :try_start_b
    new-instance p3, Lc/b/c/x/o/f;

    iget-object p4, p1, Lc/b/c/x/o/f$b;->a:Lorg/json/JSONObject;

    iget-object p6, p1, Lc/b/c/x/o/f$b;->b:Ljava/util/Date;

    iget-object p7, p1, Lc/b/c/x/o/f$b;->c:Lorg/json/JSONArray;

    iget-object p1, p1, Lc/b/c/x/o/f$b;->d:Lorg/json/JSONObject;

    .line 37
    invoke-direct {p3, p4, p6, p7, p1}, Lc/b/c/x/o/f;-><init>(Lorg/json/JSONObject;Ljava/util/Date;Lorg/json/JSONArray;Lorg/json/JSONObject;)V
    :try_end_b
    ...
    .line 39
    iget-object p4, p3, Lc/b/c/x/o/f;->c:Ljava/util/Date;

    .line 40
    invoke-direct {p1, p4, p5, p3, p2}, Lc/b/c/x/o/k$a;-><init>(Ljava/util/Date;ILc/b/c/x/o/f;Ljava/lang/String;)V
    ...
    .line 41
    new-instance p2, Lc/b/c/x/f;

    const-string p3, "Fetch failed: fetch response could not be parsed."

    invoke-direct {p2, p3, p1}, Lc/b/c/x/f;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p3, p2, p4}, Lc/b/c/x/i;-><init>(ILjava/lang/String;)V
    ...
    :goto_7
    :try_start_d
    new-instance p3, Lc/b/c/x/f;

    const-string p4, "The client had an error while calling the backend!"

    invoke-direct {p3, p4, p2}, Lc/b/c/x/f;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
