...
.method public static awaitEvenIfOnMainThread(Lc/b/a/b/i/h;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v0}, Lcom/google/firebase/crashlytics/internal/common/Utils$$Lambda$1;->lambdaFactory$(Ljava/util/concurrent/CountDownLatch;)Lc/b/a/b/i/a;

    move-result-object v2

    invoke-virtual {p0, v1, v2}, Lc/b/a/b/i/h;->f(Ljava/util/concurrent/Executor;Lc/b/a/b/i/a;)Lc/b/a/b/i/h;
...
.method public static b(Ljava/util/List;ILjava/util/Comparator;)I
    ...
    .line 4
    :cond_0
    invoke-static {p2}, Lcom/google/firebase/crashlytics/internal/common/Utils;->e(Ljava/io/File;)V
...
.method public static c(Ljava/io/File;Ljava/io/File;ILjava/util/Comparator;)I
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-static {v0, p2, p3}, Lcom/google/firebase/crashlytics/internal/common/Utils;->b(Ljava/util/List;ILjava/util/Comparator;)I
...
.method public static callTask(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lc/b/a/b/i/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, p1, v0}, Lcom/google/firebase/crashlytics/internal/common/Utils$3;-><init>(Ljava/util/concurrent/Callable;Lc/b/a/b/i/i;)V

    invoke-interface {p0, v1}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V

    .line 3
    iget-object p0, v0, Lc/b/a/b/i/i;->a:Lc/b/a/b/i/f0;

    return-object p0
.end method

.method public static synthetic d(Ljava/util/concurrent/CountDownLatch;)Ljava/lang/Object;
    .locals 0
...
.method public static e(Ljava/io/File;)V
    ...
    .line 3
    invoke-static {v3}, Lcom/google/firebase/crashlytics/internal/common/Utils;->e(Ljava/io/File;)V
...
.method public static race(Lc/b/a/b/i/h;Lc/b/a/b/i/h;)Lc/b/a/b/i/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v1, v0}, Lcom/google/firebase/crashlytics/internal/common/Utils$2;-><init>(Lc/b/a/b/i/i;)V

    .line 3
    invoke-virtual {p0, v1}, Lc/b/a/b/i/h;->e(Lc/b/a/b/i/a;)Lc/b/a/b/i/h;

    .line 4
    invoke-virtual {p1, v1}, Lc/b/a/b/i/h;->e(Lc/b/a/b/i/a;)Lc/b/a/b/i/h;
