...
.method public static final synthetic b(ZLandroid/content/BroadcastReceiver$PendingResult;Lc/b/a/b/i/h;)V
    .locals 0
...
.method public final onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 8
    new-instance p1, Lc/b/c/r/h1;

    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:Ljava/util/concurrent/ExecutorService;

    invoke-direct {p1, v0}, Lc/b/c/r/h1;-><init>(Ljava/util/concurrent/ExecutorService;)V

    goto :goto_1

    .line 9
    :cond_4
    new-instance v0, Lc/b/c/r/c;

    iget-object v1, p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:Ljava/util/concurrent/ExecutorService;

    invoke-direct {v0, p1, v1}, Lc/b/c/r/c;-><init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 12
    invoke-interface {p1, p2}, Lc/b/c/r/c0;->a(Landroid/content/Intent;)Lc/b/a/b/i/h;

    move-result-object p1

    iget-object p2, p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lc/b/c/r/a1;

    invoke-direct {v2, v0, v1}, Lc/b/c/r/a1;-><init>(ZLandroid/content/BroadcastReceiver$PendingResult;)V

    .line 13
    invoke-virtual {p1, p2, v2}, Lc/b/a/b/i/h;->b(Ljava/util/concurrent/Executor;Lc/b/a/b/i/c;)Lc/b/a/b/i/h;
