...
.method public static declared-synchronized c()Lb/k/k;
    .locals 3

    const-class v0, Lb/k/k;

    monitor-enter v0

    .line 1
    :try_start_0
    sget-object v1, Lb/k/k;->a:Lb/k/k;

    if-nez v1, :cond_0

    .line 2
    new-instance v1, Lb/k/k$a;

    const/4 v2, 0x3

    invoke-direct {v1, v2}, Lb/k/k$a;-><init>(I)V

    sput-object v1, Lb/k/k;->a:Lb/k/k;
